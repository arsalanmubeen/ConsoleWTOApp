...
namespace WTOConnector
{
    public class DataAccess
    {
        ...
        public static void InsertTimeSeriesDataPoint(Timeseries_datapoint datapoint)
        {
            ...
            using (conn)
            {
                SqlCommand cmd = new SqlCommand("insert into WTOTimeseries_datapoints values('" + datapoint.IndicatorCategoryCode + "'," +
                     "'" + datapoint.IndicatorCategory + "'," +
                    "'" + datapoint.IndicatorCode + "'," +
                    "'" + datapoint.Indicator + "'," +
                    "'" + datapoint.ReportingEconomyCode + "'," +
                    "'" + datapoint.ReportingEconomy + "'," +
                    "'" + datapoint.PartnerEconomyCode + "'," +
                    "'" + datapoint.PartnerEconomy + "'," +
                    "'" + datapoint.ProductOrSectorClassificationCode + "'," +
                    "'" + datapoint.ProductOrSectorClassification + "'," +
                    "'" + datapoint.ProductOrSectorCode + "'," +
                    "'" + datapoint.ProductOrSector + "'," +
                    "'" + datapoint.PeriodCode + "'," +
                    "'" + datapoint.Period + "'," +
                    "'" + datapoint.FrequencyCode + "'," +
                    "'" + datapoint.Frequency + "'," +
                    "'" + datapoint.UnitCode + "'," +
                    "'" + datapoint.Unit + "'," +
                    datapoint.Year + "," +
                    "'" + datapoint.ValueFlagCode + "'," +
                    "'" + datapoint.ValueFlag + "'," +
                    "'" + datapoint.TextValue + "'," +
                    datapoint.Value + ");", conn);
